...
public class InterWeb {
	...
	//分班播报获取对应班级跟播报码
	private String URL_Broadcast = web + "/Equipment/getall_broadcastcode?accesstoken="+MAC;
	
	//获取APK信息
	private String URL_APKVersion = web + "/apk/listofapk?accesstoken="+MAC+"&type=5";
	// 打卡时间设置
	...
	public void setURL_OSS(String uRL_OSS) {
	 ...
	 public String getURL_SchoolInfoMain() {
		...
		public String getURL_Broadcast() {
			return URL_Broadcast;
		}

		public void setURL_Broadcast(String uRL_Broadcast) {
			URL_Broadcast = uRL_Broadcast;
		}
}
